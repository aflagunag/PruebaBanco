...
var ds = app.datasources.PERSONA;
...
function modelosCB(err, tablas) {
    if (err) { console.log(err); }
        ...
        tablas.forEach(function (definicion) {
            ...
            ds.discoverSchema('PERSONA', { schema: 'PERSONA', associations: true, views: true }, schemaCB);
        });
...
ds.discoverModelDefinitions({ schema: 'PERSONA' }, modelosCB);
